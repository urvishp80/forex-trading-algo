...
#     feature_save_path = f'./data/feature_names_{i}.pkl'
...
#
# model_save_path = f'./{MODELS_FOLDER}/{CURRENCY_NAME}/lgb_{str(CURRENCY_NAME)}.txt'
# saved_path = f'./{MODELS_FOLDER}/{CURRENCY_NAME}/lgb_{str(CURRENCY_NAME)}.txt'
